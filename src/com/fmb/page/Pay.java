...
public class Pay 
{
	...
	{
		confirmpage_active_title_1 = be.getTableCellText(3, CommonFun.yamlconf.getYamlValue("fmb_confirmorder_active_title_jingdian"));   //元素定位选择".//div/"其中。是table节点
		confirmpage_active_title_1 = confirmpage_active_title_1.trim();
		confirmpage_ticket_type_1 = be.getTableCellText(3, CommonFun.yamlconf.getYamlValue("fmb_confirmorder_active_ticket_type_jingdian"));   //所用的方法getTableCellText()其中3为当前页面中table标签元素的个数，从1开始取值，且3个table外边的table标签不算
